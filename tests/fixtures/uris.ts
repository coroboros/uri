...
export const notUri: unknown[] = [
  ...
  'foo://user:%agpass@example.com:8042/over/there?name=ferret#nose',
  'foo://user:pass%@example.com:8042/over/there?name=ferret#nose',
  ...
  'foo://example.com:8042/over/there%Ag?name=ferret#nose',
  'foo://example.com:8042/%2gover/there%20%20?name=ferret#nose',
  ...
  'foo://example.com:8042/over/there?name=ferret#nose%eg',
  'foo://example.com:8042/over/there?name=ferret#nose%ag',
  'foo://example.com:8042/over/there?name=ferret#nose%9',
  'foo://example.com:8042/over/there?name=ferret#nose%8g',
  'foo://example.com:8042/over/there?name=ferret#nose%az',
  'foo://example.com:8042/over/"there?name=ferret#nose',
];
...
export const http: string[] = [
  ...
  'http://user:pass@[fe80::7:8%25eth0]:8080/',
  'http://user:pass@[fe80::7:8%25eth0]/path?q=5#anchor',
  'http://example.com./',
...
export const notIdn: string[] = ['http://user:pass@xn--iñvalid.com:8080'];
...
export const notSitemap: string[] = [
  'http://user:pass@example.com./over/there?page=5&x=1#coin',
  'https://中文.com:8042/over/there?name=ferret&pseudo=superhero#nose',
  ...
  'http://example.com:8042/%2gover/there%20%20?name=ferret#nose',
  ...
  'http://example.com:8042/over/there?name=ferret#nose%eg',
  'http://example.com:8042/over/there?name=ferret#nose%ag',
  'http://example.com:8042/over/there?name=ferret#nose%9',
  'http://example.com:8042/over/there?name=ferret#nose%8g',
  'http://example.com:8042/over/there?name=ferret#nose%az',
  "http://example.com:8042/it'sover/there?name=ferret#nose",
